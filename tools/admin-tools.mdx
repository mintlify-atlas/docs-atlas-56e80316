---
title: "Read-Only Admin Tools for R2 Bucket and Account Data"
...
Get account-level R2 storage metrics, including total object count and storage bytes consumed across all buckets in the account.
