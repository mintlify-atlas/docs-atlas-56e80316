...
description: "A remote MCP server that exposes Cloudflare R2 object storage operations to AI clients like ChatGPT, secured with GitHub OAuth and running on Cloudflare Workers."
---
